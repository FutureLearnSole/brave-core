...
const handlePublisherInfoResponse = (response: PublisherInfoResponse, windowId: number, tabId: number) => {
  ...
  switch (response.mediaType) {
    case 'youtube':
      handlePublisherInfoYoutube(response.publisherInfo, windowId, tabId)
      break
    default:
...
chrome.runtime.onMessageExternal.addListener((msg, sender, sendResponse) => {
  ...
  handlePublisherInfoResponse(msg, windowId, tabId)
})
