...
void RewardsServiceImpl::SaveMediaVisitYoutubeVideo(
    const uint64_t window_id,
    const std::string& url,
    const std::string& channel_id,
    const std::string& publisher_key,
  ...
  bat_ledger_->SaveMediaVisitYoutubeVideo(
      window_id,
      url,
      channel_id,
      publisher_key,
...
void RewardsServiceImpl::SaveMediaVisitYoutubeCustom(
    const uint64_t window_id,
    const std::string& url,
    const std::string& channel_id,
    const std::string& publisher_key,
  ...
  bat_ledger_->SaveMediaVisitYoutubeCustom(
      window_id,
      url,
      channel_id,
      publisher_key,
