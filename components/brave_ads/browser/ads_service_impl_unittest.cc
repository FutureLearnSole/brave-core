...
class MockRewardsService : public RewardsService {
 public:
  ...
  MOCK_METHOD6(GetPublisherPanelInfo, void(
      const uint64_t,
      const std::string&,
      const std::string&,
      const std::string&,
      const std::string&,
      const std::string&));
  MOCK_METHOD6(SaveMediaVisitYoutubeChannel, void(
      const uint64_t,
      const std::string&,
      const std::string&,
      const std::string&,
      const std::string&,
      const std::string&));
  MOCK_METHOD6(SaveMediaVisitYoutubeUser, void(
      const uint64_t,
      const std::string&,
      const std::string&,
      const std::string&,
      const std::string&,
      const std::string&));
  MOCK_METHOD7(SaveMediaVisitYoutubeVideo, void(
      const uint64_t,
      const std::string&,
      const std::string&,
      const std::string&,
      ...
      const std::string&,
      const std::string&));
  MOCK_METHOD6(SaveMediaVisitYoutubeCustom, void(
      const uint64_t,
      const std::string&,
      const std::string&,
      const std::string&,
