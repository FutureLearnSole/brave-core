...
TEST_F(BatAdsAdConversionsTest,
  ...
  // Act
  get_ad_conversions()->Check("https://www.brave.com/signup");
...
TEST_F(BatAdsAdConversionsTest,
  ...
  // Act
  get_ad_conversions()->Check("https://www.brave.com/welcome");
...
TEST_F(BatAdsAdConversionsTest,
  ...
  // Act
  get_ad_conversions()->Check("https://www.brave.com/");
...
TEST_F(BatAdsAdConversionsTest,
  ...
  // Act
  get_ad_conversions()->Check("https://www.foobar.com/");
